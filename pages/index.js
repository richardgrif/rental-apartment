  ...
  return (
    <div>
      ...
      <div className='relative'>
        ...
        {/* BANNER PIC WITH TEXT AND CALENDAR BUTTON SECTION*/}
        <div className='absolute inset-0'>
          <img className='h-full w-full object-cover' src='/img/1.jpeg' />
        </div>
        <div className='relative px-4 py-16 sm:py-24 lg:py-32 lg:px-8 bg-gray-800/80'>
            ...
            <div className=''>
              <Link href={`/calendar`}>
                <a className='flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 sm:px-8'>
                  See avaliability calendar and prices
                </a>
              </Link>
            </div>
          </div>
      ...
      <div className='relative py-16 sm:py-24 lg:py-32'>
        <div className='mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl'>
          ...
          <p className='mt-5 max-w-prose mx-auto text-xl text-gray-300'>
              From challenging mountain trails to beautiful alpine lakes to cities, lots of
              destinations in reach for a day trip
          </p>
          <div className='mt-12'>
